...
| SHOULD-04 | `NormativeIntegrationComplianceTests.Should04_Verifier_RejectsExpirationBeyondThreeMonths_WhenPolicyEnabled` (verifier SHOULD, opt-in); `Should04_Delegation_DoesNotThrowOnLongExpirationAtCreateTime` (create-time no-throw) |
